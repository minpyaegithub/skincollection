...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Treatment</h1>
        <a href="{{route('treatment.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="#">
                    ...
                    <div class="form-group" style="margin-top:-30px;">
                        <div class="row">
                            ...
                            <table id="tbl_pharmacy">
                                ...
                                @foreach($treatment_phar as $t_phar)
                                <tr value="{{$t_phar->phar_id}}">
                                    <td>
                                        <input class="form-control" placeholder="0" type="hidden" value="{{$t_phar->phar_id}}" name="phar_id"/>
                                        <input class="form-control" placeholder="0" type="text" value="{{$t_phar->name}}" name="phar_name" disabled/>
                                    </td>
                                    <td>
                                        <input class="form-control" placeholder="0" type="number" value="{{$t_phar->qty}}" name="qty"/>
                                    </td>
                                    <td>
            ...
            <div class="card-footer">
                <button type="button" id="btn_update" class="btn btn-success btn-user float-right mb-3">Update</button>
    ...
    $(function () {
        ...
        $("#btn_update").on("click", function() {
            ...
            $.ajax({
               ...
               type:'PUT',
               url:'{{route('treatment.update', ['treatment' => $treatment->id]) }}',
               data: data,
               success:function(data) {
                    ...
                    if(data.message == 'fail'){
                        ...
                        $("#err_name").hide();
                        window.location.href = "{{ route('treatment.updateIndex')}}";
                    }
               }
            });
